...
You can read about it [here](/docs/5.2/ios/features/catalog/customize-views).
...
You can read about it [here](/docs/5.2/ios/features/recipe-card/customize-views).
...
You can read about it [here](/docs/5.2/ios/features/favorites/customize-views).
...
You can read about it [here](/docs/5.2/ios/features/myMeals/customize-views).
