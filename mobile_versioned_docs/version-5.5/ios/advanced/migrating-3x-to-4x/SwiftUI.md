...
You can read about it [here](/docs/5.5/ios/features/catalog/customize-views).
...
You can read about it [here](/docs/5.5/ios/features/recipe-card/customize-views).
...
You can read about it [here](/docs/5.5/ios/features/favorites/customize-views).
...
You can read about it [here](/docs/5.5/ios/features/myMeals/customize-views).
