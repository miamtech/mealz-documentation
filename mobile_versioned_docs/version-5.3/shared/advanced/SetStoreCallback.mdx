...
import AndroidSetStoreRedirectionConfig from '../../android/advanced/_shared/_user/_SetStoreRedirectionConfig.mdx'

import IosSetStoreRedirectionConfig from '../../ios/advanced/_shared/_user/_SetStoreRedirectionConfig.mdx'
