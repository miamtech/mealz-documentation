...
You can read about it [here](/docs/5.7/ios/features/catalog/customize-views).
...
You can read about it [here](/docs/5.7/ios/features/recipe-card/customize-views).
...
You can read about it [here](/docs/5.7/ios/features/favorites/customize-views).
...
You can read about it [here](/docs/5.7/ios/features/myMeals/customize-views).
