...
import AndroidMealzSingletonSample from './_shared/_MealzSingletonSample.mdx'

## Create module

First & foremost, we recommend creating an Android Module to house all your Mealz SDK related code.
...
<AndroidMealzSingletonSample></AndroidMealzSingletonSample>
