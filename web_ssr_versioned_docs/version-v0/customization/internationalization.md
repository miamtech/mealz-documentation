...
The internationalization of our components is based on the mandatory [HTTP request header](/docs/web_ssr/v0/main-features/pre-rendered-components#http-request-headers) `Language-id` that you provide on each API call.
