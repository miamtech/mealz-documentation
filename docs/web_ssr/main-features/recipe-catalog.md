...
See [Internationalisation](/docs/web_ssr/v2/customization/internationalization) for more information on how to configure a custom I18n file to override our base texts with your own.
See [the recipe card](/docs/web_ssr/v2/main-features/recipe-card#i18n) to see its customizable text contents 