...
If the user logs in while Mealz is not active, you will need to call the /merge-authless-basket route to inform us of the login (see [here](/docs/web_ssr/v2/set-up-and-usage/login-and-logout#when-mealz-scripts-are-not-active)). 
