...
To create your own recipe detail oftend deleted product template you have to create class that implement `UnavailableProductsHeader`
...
To create your own recipe detail unavailable product template you have to create class that implement `UnavailableProduct`
