...
- **ignored** : product won't be fetched 
...
To create your own recipe detail product success template you have to create class that implement `ProductSuccess`
...
To create your own recipe detail product loading template you have to create class that implement `ProductLoading`
...
To create your own recipe detail product ignore template you have to create class that implement `ProductIgnore`
