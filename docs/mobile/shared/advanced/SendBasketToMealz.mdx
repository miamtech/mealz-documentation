...
import AndroidSendBasketToMealz from '../../android/advanced/_shared/_basket/_SendBasketToMealz.mdx'

import IosSendBasketToMealz from '../../ios/advanced/_shared/_basket/_SendBasketToMealz.mdx'
