...
import AndroidMealzSingletonSample from '../../android/overview/_shared/_MealzSingletonSample.mdx'
import IOSMealzSingletonSample from '../../ios/overview/_shared/_MealzSingletonSample.mdx'

export function Package(props){
    if(props.platform == "android") { return "an Android Module" } else return "a Swift Package"
}

export function MealzSingletonSample(props) {
  if(props.platform == "android") { return <AndroidMealzSingletonSample></AndroidMealzSingletonSample>  } else return <IOSMealzSingletonSample></IOSMealzSingletonSample>
}
...
First & foremost, we recommend creating <Package platform={props.platform}></Package> to house all your Mealz SDK related code.
...
<MealzSingletonSample platform={props.platform}></MealzSingletonSample>
