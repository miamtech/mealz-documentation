...
- Inputs :
  ...
  - `contextId: string` <Badge text="since 9.2.8" color="info" href="../Changelog#v928---02102025" /> : **_(Optional)_** : `contextId` corresponds to the card's position (e.g., "1", "2", "3") for shelf suggestions injection.
